...
#adaptation to read different input sizes.
def calcDimension(data):
    return((len(data[0].strip()),len(data)))

def part1(path):
    with open(path) as f:
        data = f.readlines()
    maxY,maxX = calcDimension(data)
    #print(f"Start part1 with size h{maxX} w{maxY}")
    totalVisible = 0
...
def part2(path):
    with open(path) as f:
        data = f.readlines()
    maxY,maxX = calcDimension(data)
    #print(f"Start part2 with size h{maxX} w{maxY}")
    Highscore = 0
    for x in range(0,maxX):
        for y in range(0,maxY):
...
if __name__ == '__main__':
    ...
    path = "2022/08/inputs/aoc_2022_day08_rect.txt"
    print('part 1:', part1(path))
    print(f"### input: {path} part 1: {(int(round(time() * 1000)) - PerInputTime)} miliseconds")
    ...
    PerInputTime = int(round(time() * 1000))
    path = "2022/08/inputs/aoc_2022_day08_sparse.txt"
    #print('part 1:', part1(path))
    #print(f"### input: {path} part 1: {(int(round(time() * 1000)) - PerInputTime)} miliseconds")
    PerInputTime = int(round(time() * 1000))
    print('part 2:', part2(path))
    ...
    #print('part 1:', part1("2022/08/inputs/aoc_2022_day08_rect.txt"))
    #print('example part 1:', part1("2022/08/inputs/example.txt",5,5))
    #print('part 2:', part2("2022/08/inputs/aoc_2022_day08_rect.txt"))
